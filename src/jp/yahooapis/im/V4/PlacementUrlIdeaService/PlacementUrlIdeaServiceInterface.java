 ...
 * 
 */
@WebService(name = "PlacementUrlIdeaServiceInterface", targetNamespace = "http://im.yahooapis.jp/V4")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface PlacementUrlIdeaServiceInterface {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "get", targetNamespace = "http://im.yahooapis.jp/V4", className = "jp.yahooapis.im.V4.PlacementUrlIdeaService.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "http://im.yahooapis.jp/V4", className = "jp.yahooapis.im.V4.PlacementUrlIdeaService.GetResponse")
    public void get(
